...
<!--                
	<li class="nav-item"><a class="nav-link collapsed" href="#"
		...
		aria-controls="collapseTwo"> <i class="fas fa-fw fa-cog"></i> <span>Game Settings</span>
	</a>
		<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
			data-parent="#accordionSidebar">
			<div class="bg-white py-2 collapse-inner rounded">
				<h6 class="collapse-header">Custom Components:</h6>
                                <a class="collapse-item" href="gamediff.php">Difficulty</a> <a
                                    class="collapse-item" href="tutorial.php">Tutorial</a>
                                <a
                                    class="collapse-item" href="leaderboard.php">Leaderboard</a>
			</div>
		</div></li>-->

	<!-- Nav Item - Utilities Collapse Menu -->
<!--	<li class="nav-item"><a class="nav-link collapsed" href="../../challenges.php"> <i
			class="fas fa-fw fa-wrench"></i> <span>Challenges</span>
	</a>
		</li>-->
