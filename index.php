                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Default Obstacle Detection (cm)</div>
                        ...
                        <!--<div class="col-xl-4 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Default Obstacle Detection (cm)
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">2 CM</div>
                                                </div>
                                                <div class="col">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">IR-Acer Frequency Usage</h6>
                    ...
                    <div class="row">
                      ...
                      <!--  <div class="col-lg-6 mb-4">  -->
                           ...
                           <!-- <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <p>IR-Acer makes extensive use of Bootstrap 4 utility classes in order to reduce
